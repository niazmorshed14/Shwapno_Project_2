...
public class Shawpno {
	...
	public static String area = "Mugda";
	...
	public static void setLocation() throws InterruptedException {
		...
		Select myCity = new Select(driver.findElement(By.xpath("//select[@id='state']")));
		myCity.selectByVisibleText(city);
		Thread.sleep(1000);
		
		Select myArea = new Select(driver.findElement(By.xpath("//select[@id='city']")));
		myArea.selectByVisibleText(area);
		Thread.sleep(1000);
	...
	public static void loginModule() throws InterruptedException{
		...
		driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_ctl00_ctl01_Login1_UserName']")).sendKeys("fortest178@yahoo.com	");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_ctl00_ctl01_Login1_Password']")).sendKeys("abcdef14");
		Thread.sleep(1000);
	...
	public static void findProduct() throws InterruptedException{
		driver.findElement(By.xpath("//span[normalize-space()='Buy1 Get1 Offers']")).click();
		Thread.sleep(1000);
		
		driver.findElement(By.xpath("//img[@src='//storage.sg.content-cdn.io/cdn-cgi/image/width=400,height=400,quality=75,format=auto,fit=cover,g=top/in-resources/8845e144-8902-4204-b80f-9dc7dc2f4bcb/Images/ProductImages/Source/2815469.jpg']")).click();
		Thread.sleep(1000);
	}
